...
// trying to get some working code for the LPY503AL from sparkfun. Sensor SEN-11341 connected to pin A2
// this code assumes an accelerometer ADXL335 connected to pin A0
//
...
// 01 by default
float gyro_angle;
float loop_time = -0.05; // this may need to be made positive instead of negative if gyro is counting in the wrong direction.
